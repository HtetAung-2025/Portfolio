...
const Projects = () => {
    ...
    //Reser Carousel Whwn category changes
    ...
    return (
        <section id="projects" className="relative py-10 bg-black overflow-hidden">
            <div className="absolute insrt-0 overflow-hidden">
                <div className="absolute top-1/3 right-0 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3xl" />
                <div className="absolute botttom-1/3 left-0 w-96 h-96 bg-primary/20 opacity-20 rounded-full blur-3xl" />
                ...
                <FadeIn delay={0}>
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg  text-white/60 max-w-2xl mx-auto">
                            クライアント企業の課題解決に取り組んだ実習制作や、技術向上を目的に自習した作品を掲載しています。
                            Reactによる実装作品に加え、Figmaを用いたデザインのみの設計案も公開しており、企画からビジュアル構築、コードへの落とし込みまでの一連のプロセスを提示しています。
                        </p>
                    </div>
                </FadeIn>
                {/**Category Filter */}
                        ...
                        {filteredProjects.length > 3 && (
                            <>
                                <button
                                    ...
                                    className="flex absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 lg:translate-x-2 lg-translate-x-4 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20 transition-all duration-300  disabled:opacity-50 disable:cursor-not-allowed z-10"
                                ...
                                <button
                                    ...
                                    className="flex absolute right-0 top-1/2 -translate-y-1/2 -translate-x-2 lg:translate-x-2 lg-translate-x-4 items-center justify-center w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full hover:bg-white/20 transition-all duration-300  disabled:opacity-50 disable:cursor-not-allowed z-10"
