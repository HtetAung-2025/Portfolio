            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="groupo flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 hover:border-primary/30 transition-all duration-300"
                >
                ...
                <div className="groupo flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 hover:border-primary/30 transition-all duration-300">
                  <div className="p-2 bg-primary/10 rounded-lg">
  ...
  {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
    ...
    return Icon ? (
      ...
      >
        ...
        <div className="absolute inset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:from-primary/0 group-hover:to-primary/0 rounded-xl transition-all duration-300 pointer-events-none"/>
      </a>
    ) : null;
  })}
</div>
